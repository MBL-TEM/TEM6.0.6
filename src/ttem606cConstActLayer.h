/* *************************************************************
****************************************************************
TTEM606CCONSTACTLAYER.H - Terrestrial Ecosystem Model Version 
  6.0.6.  The seasonal active layer in permafrost regions is 
  assumed to remain constant after year 2000. 
****************************************************************
...
#include "tveg606c.h"    // TTEM uses Tveg60 class
#include "tsoil606bConstActLayer.h"  // TTEM uses Tsoil60 class
#include "tmcrb606b.h"   // TTEM uses Tmicrobe60 class

// Objects describing the effects of human activities on the ecosystem

#include "humnact606c.h" // TTEM uses Humnact60 class
