/* **************************************************************
*****************************************************************
TELM606CNOFERT2000.CPP - Runs TEM for a single grid cell. Nitrogen
  fertilizers are assumed to be applied to croplands from 1950 to
