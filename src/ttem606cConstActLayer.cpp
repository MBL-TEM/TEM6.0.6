/* *************************************************************
****************************************************************
TTEM606CCONSTACTLAYER.CPP - Terrestrial Ecosystem Model Version 
...
#include "ttem606cConstActLayer.h"
                         ...
                         ofstream& rflog1 )
{
      ...
      && ag.cmnt != LAKES )
  {
    ...
    if( totyr > 2000 )
    {
    	soil.setACTLAYER( soil.getCONSTACTLAYER( pdm ) );
    }
    else
    {
    	soil.setCONSTACTLAYER( soil.getACTLAYER(), pdm );
    }
