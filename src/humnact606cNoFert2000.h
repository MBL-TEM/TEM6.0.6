/* *************************************************************
****************************************************************
HUMNACT606CNoFERT2000.H - describes human disturbances to natural 
  ecosystems where nitrogen fertilizers are assumed to be applied
  to croplands from 1950 to 2000, but then no fertilizers are
  applied to croplands after year 2000.
...
#include "tveg606cNoFert2000.h" // Humanact60 uses Tveg60 class
