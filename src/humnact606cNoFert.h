/* *************************************************************
****************************************************************
HUMNACT606CNOFERT.H - describes human disturbances to natural 
  ecosystems where N fertilizers are never applied to 
  croplands.
...
#include "tveg606cNoFert.h" // Humanact60 uses Tveg60 class
