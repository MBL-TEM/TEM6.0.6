/* **************************************************************
*****************************************************************
TELM606CCONSTACTLAYER.H - Determines the interface among CLM, 
  LCLUC and TEM modules.  The seasonal active layer in 
  permafrost regions is assumed to remain constant after year 
  2000.
...
#include "telmntcohort606cConstActLayer.hpp"  

#include "tlcluc606.h" // TEMelmnt60 uses the TEMlcluc60 class
#include "ttem606cConstActLayer.h"   // TEMelmnt60 uses the TTEM60 class
