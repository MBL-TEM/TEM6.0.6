/* **************************************************************
*****************************************************************
TELM606CNOFERT.H - Determines the interface among CLM, LCLUC and 
  TEM modules.  Nitrogen fertilizers are never assumed to be
...
#include "ttem606cNoFert.h" // TEMelmnt60 uses the TTEM60 class
