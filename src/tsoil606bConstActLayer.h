/* **************************************************************
*****************************************************************
TSOIL606BCONSTACTLAYER.H - object describing characteristics of 
  soil used by the Terrestrial Ecosystem Model (TEM).  The 
  seasonal active layer in permafrost regions is assumed to 
  remain constant after year 2000.
...
************************************************************** */
     ...
     inline double getCONSTACTLAYER( const int& pdm ) 
     { 
     	return constActLayer[pdm]; }

     inline void setCONSTACTLAYER( const double& pactlayer, 
                                   const int& pdm ) 
     { 
       constActLayer[pdm] = pactlayer; 
     }
...
************************************************************** */
     ...
     // Container for active layer depth when active layer is 
